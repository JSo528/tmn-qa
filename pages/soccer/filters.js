...
Filters.prototype.changeValuesForSeasonWeekDropdownFilter = function(seasonFrom, weekFrom, seasonTo, weekTo, update) {
  var seasonFromLocator = By.xpath(".//div[@id='filterSet']/.//div[@id='s2id_filterFootballSeasonWeekFromSeason']/a")
  var seasonFromInputLocator = By.xpath(`.//ul[@class='select2-results']/li/div[text()="${seasonFrom}"]`);
  var weekFromLocator = By.xpath(".//div[@id='filterSet']/.//div[@id='s2id_filterFootballSeasonWeekFromWeek']/a")
  var weekFromInputLocator = By.xpath(`.//ul[@class='select2-results']/li/div[text()="${weekFrom}"]`);
  var seasonToLocator = By.xpath(".//div[@id='filterSet']/.//div[@id='s2id_filterFootballSeasonWeekToSeason']/a")
  var seasonToInputLocator = By.xpath(`.//ul[@class='select2-results']/li/div[text()="${seasonTo}"]`);
  var weekToLocator = By.xpath(".//div[@id='filterSet']/.//div[@id='s2id_filterFootballSeasonWeekToWeek']/a")
  var weekToInputLocator = By.xpath(`.//ul[@class='select2-results']/li/div[text()="${weekTo}"]`);

  this.click(seasonFromLocator);
  this.click(seasonFromInputLocator);
  this.click(weekFromLocator);
  this.click(weekFromInputLocator);
  this.click(seasonToLocator);
  this.click(seasonToInputLocator);
  this.click(weekToLocator);
  this.click(weekToInputLocator);
