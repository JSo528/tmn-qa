...
var X_AXIS_FILTER_SELECT = By.css("#xAxisFilters #s2id_addFilter");
var Y_AXIS_FILTER_SELECT = By.css("#yAxisFilters #s2id_addFilter");

var INPUT = By.xpath(".//div[@id='select2-drop']/div/input");

var GLOBAL_FILTER_UPDATE_BTN = By.css("#filterSet button.update");
var X_AXIS_FILTER_UPDATE_BTN = By.css("#xAxisFilters button.update");
var Y_AXIS_FILTER_UPDATE_BTN = By.css("#yAxisFilters button.update");
