...
ScatterPlotPage.prototype.changeXStat = function(xStat) {
  return this.changeDropdown(X_STAT_SELECT, DROPDOWN_INPUT, xStat);
};

ScatterPlotPage.prototype.changeYStat = function(yStat) {
  return this.changeDropdown(Y_STAT_SELECT, DROPDOWN_INPUT, yStat);
};

ScatterPlotPage.prototype.addGlobalFilter = function(filter) {
  return this.changeDropdown(GLOBAL_FILTER_SELECT, DROPDOWN_INPUT, filter);
};

ScatterPlotPage.prototype.addXFilter = function(filter) {
  return this.changeDropdown(X_AXIS_FILTER_SELECT, DROPDOWN_INPUT, filter);
};

ScatterPlotPage.prototype.addYFilter = function(filter) {
  return this.changeDropdown(Y_AXIS_FILTER_SELECT, DROPDOWN_INPUT, filter);
};
