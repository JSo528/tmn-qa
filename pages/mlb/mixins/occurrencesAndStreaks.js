...
OccurrencesAndStreaks = {
  ...
  *****************************************************************************/
  ...
  STREAK_TYPE_SELECT: By.id('s2id_pageControlBaseballStrkType'),
  CONSTRAINT_COMPARE_SELECT: By.id('s2id_pageControlBaseballStrkConstraintCompare'),
  CONSTRAINT_VALUE_INPUT: By.id('pageControlBaseballStrkConstraintValue'),
  DEFAULT_CONSTRAINT_STAT_SELECT: By.id('s2id_pageControlBaseballStrkConstraintStat'),
  DEFAULT_STREAK_GROUPING_SELECT: By.id('s2id_pageControlBaseballStrkGrouping'),
  STREAK_SCOPE_SELECT: By.id('s2id_pageControlBaseballStrkScope'),
  UPDATE_CONSTRAINTS_BUTTON: By.id('pageControlBaseballStrkBtnUpdate'),
