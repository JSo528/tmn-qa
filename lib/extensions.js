...
var customSortStringsInsensitive = function(arr, direction) {
  var newArray = arr.slice(0);
  return newArray.sort(function(a,b) {
    if (direction == 'asc') {
...
var customSortByType = function(type, arr, direction, enumeration) {
  switch (type) {
    case 'enumerated':
      return customSortEnumerated(arr, direction, enumeration);
    case 'stringsInsensitive':
      return customSortStringsInsensitive(arr, direction);
    case 'dates':
...
module.exports = {
  ...
  customSortStringsInsensitive: customSortStringsInsensitive,
