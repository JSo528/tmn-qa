...
var navbar, searchPage, scoutingReportPage, filters;
...
test.describe('#Page: PlayersSearch', function() {
  ...
  test.describe('#filters', function() {
    ...
    var rangeFilters = [
      ...
      { name: 'Entry Year', minValue: '2017', maxValue: '2017', result: 'Dimick' },
    ...
    test.beforeEach(function() {
      browser.refresh();
      searchPage.changePlayersNumberOfRows(50);
    });
  ...
  test.describe('#createReport', function() {
    test.it('clicking create scouting report from dropdown goes to correct new scouting report page', function() {
      searchPage.clickCreateScoutingReport(1);
